...
class AdminsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admins')->with('info','New user has been created!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->setAdmin($request, $admin ,$fileNameToStore);
        return redirect('/admins')->with('info','selected user has been updated');
    }
    ...
    public function destroy($id)
    {
        ...
        if($id == Auth::user()->id){
            ...
            return redirect('/admins')->with('info','Authenticated user cannot be deleted!');
        }
        ...
        Storage::delete('public/admins/'.$admin->picture);
        $admin->delete();
        return redirect('/admins')->with('info','selected user has been deleted!');
    }
